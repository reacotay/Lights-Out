...
namespace LightsOut2
{
    class Rager : Enemy
    {
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            {
                spriteBatch.Draw(texture, new Vector2(position.X, position.Y), new Rectangle(0, 0, texture.Width, texture.Height), Color.Red, angle, new Vector2(texture.Width / 2, texture.Height / 2), 1f, SpriteEffects.None, 0f);
            }
        }
